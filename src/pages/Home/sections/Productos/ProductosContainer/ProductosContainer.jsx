      ...
      try {
        ...
        setProductos(
          respuesta.docs.map((doc) => ({
            ...doc.data(),
            id: doc.id, //Este id es el automático de firebase, pero no lo necesito ya que tengo mi propio id creado por mi (dentro de data), pero lo agrego con otro nombre por si lo necesito más adelante para implementar alta, edición o eliminación de productos.
          })),
        );
      } catch (error) {
